...
layui.config({
    base: 'http://seo.lusanguo.cn/Static/lay_ui_ext/cropper/' //layui自定义layui组件目录
}).define(['jquery','layer','cropper'],function (exports) {
    var $ = layui.jquery
        ,layer = layui.layer;
    var html = "<link rel=\"stylesheet\" href=\"http://seo.lusanguo.cn/Static/lay_ui_ext/cropper/cropper.css\">\n" +
